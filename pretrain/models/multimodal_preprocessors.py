...
class SequPreprocessor(nn.Module):
    """Process the original sequence input to a fixed size

    Args:
        output_size (tuple): define the output size of average pool operation
    """
...
class StruPreprocessor(nn.Module):
    """Process the original structure input to a fixed size
    ...
    def forward(self, structure=None):
        return_dict = {
            "trunk": {
                "tokens": structure,
            },
