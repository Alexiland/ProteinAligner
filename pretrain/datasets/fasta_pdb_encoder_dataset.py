...
from models.proteinbind_encoder_model import ModalityType
import data
...
class FastaPdbDataset(Dataset):
    ...
    def collate_fn(self, samples):
        ...
        for fasta_data in samples:
            ...
            fasta_ids.append(fasta_data['fasta_id'])
        ...
        for pdb_data in samples:
            ...
            pdb_ids.append(pdb_data['pdb_id'])
        coords, confidence, strs, tokens, padding_mask = self.pdb_batch_converter(
            pdb_batch, device=None)

        return fasta_batch_tokens, ModalityType.SEQUENCE, (coords, confidence, strs, tokens, padding_mask), ModalityType.STRUCTURE
