...
def _load_model_and_alphabet_core_v1(model_data):
    import esm  # since esm_li.inverse_folding is imported below, you actually have to re-import esm here
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: esm_li.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
